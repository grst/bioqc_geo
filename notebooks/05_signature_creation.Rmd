...
```{r, echo=FALSE, fig.cap="Confusion matrix of rosubst signatures."}
...
```{r, echo=FALSE, fig.cap="Cross-platform, cross-species validation of the robust signatures identified in the previous step."}
