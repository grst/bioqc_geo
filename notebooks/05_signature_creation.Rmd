...
```{r, echo=FALSE, fig.cap="Confusion matrix of the cross-validation.", out.width="100%"}
...
```{r, echo=FALSE, fig.cap="Confusion matrix of rosubst signatures.", out.width="50%"}
...
```{r, echo=FALSE, fig.cap="Cross-platform, cross-species validation of the robust signatures identified in the previous step.", out.width="70%"}
