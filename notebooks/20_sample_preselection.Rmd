...
```{r sample_filtering, fig.height=3, fig.width=8, cache=TRUE, include=FALSE}
sqlStats = "
...
```{r sample-filtering2, echo=FALSE, fig.height=3, fig.width=7, cache=FALSE, message=FALSE, warning=FALSE, fig.cap="Venn diagrams comparing two different approaches for annotating gene symbols. The left and right diagram show the numbers of samples (GSM) and studies (GSE) respectively."}
