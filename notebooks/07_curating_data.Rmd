...
```{r funnelgeo, out.width="40%", echo=FALSE, fig.cap="Summary of filtering steps on GEO samples", fig.align="center"}
...
```{r funnelarchs, out.width="40%", echo=FALSE, fig.cap="Summary of filtering steps on ARCHS4 samples", fig.align='center'}
