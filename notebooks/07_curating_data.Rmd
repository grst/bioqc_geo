...
```{r funnelgeo, out.width="40%", echo=FALSE, fig.cap="Summary of filtering steps on GEO samples", fig.align="center", fig.pos="h"}
knitr::include_graphics("figures/funnel_geo.png")
```
...
```{r funnelarchs, out.width="40%", echo=FALSE, fig.cap="Summary of filtering steps on ARCHS4 samples", fig.align='center', fig.pos="h"}
knitr::include_graphics("figures/funnel_archs4.png")
```
